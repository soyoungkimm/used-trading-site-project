...
@section('content')
    ...
    <script>
        ...
        function textareaSize(obj, defaultSize) {
            let textarea = document.getElementById(obj);
            let size = (textarea.scrollHeight >= defaultSize) ? textarea.scrollHeight + "px" : defaultSize + "px";

            textarea.style.height = defaultSize + "px";
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputTitle" name="title" type="text"
                                                   placeholder="제목" value="{{ $notice->title }}"/>
                                            <label for="inputTitle">제목</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputWriteday" name="writeday" type="date"
                                                   placeholder="작성일" value="{{ $notice->writeday }}"/>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" id="content"
                                                  style="resize: none"
                                                  onchange="textareaSize('content', 150);"
                                                  onkeyup="textareaSize('content', 150);"
