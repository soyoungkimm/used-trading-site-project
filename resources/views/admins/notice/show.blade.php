                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <div class="form-control" id="inputTitle" name="title"
                                                 type="text">{{ $notice->title }}</div>
                                            <label for="inputTitle">제목</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <div class="form-control" id="inputWriteday" name="writeday"
                                                 type="date">{{ $notice->writeday }}</div>
                                            <label for="inputFollower">작성일</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <label>내용</label>
                                        <div class="form-control h-100" id=""
                                             name="content">{!! nl2br($notice->content) !!}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
