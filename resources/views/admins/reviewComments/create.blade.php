...
<main>
    <div class="container-fluid px-4">
        ...
        <br>
        <div class="card mb-4">
            <form action="/admin/review_comments" method="POST">
                @csrf
                <div class="card-header">
                    <i class="fas fa-table me-1"></i> review_comments table 
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="70%">
                                    <select class="form-select @error('review_id') is-invalid @enderror" aria-label="Default select example" name="review_id" required>
                                        <option value="0" selected>후기를 고르세요</option>
                                        {{-- 유효성 검사 걸린 경우 --}}
                                        @if (old('review_id') != '') 
                            ...
                            <tr>
                                <th width="30%">content(내용) <span style="color : red;">*</span></th>
                                <td width="70%">
