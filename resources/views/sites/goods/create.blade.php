                    ...
                    <table class="table table-striped">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <input class="@error('price') is-invalid @enderror" type="text" id="price" name="price" placeholder="숫자만 입력하세요" value="{{ old('price') ? old('price') : '100' }}"/><span class="input_left">원</span>
                                <br><br>
